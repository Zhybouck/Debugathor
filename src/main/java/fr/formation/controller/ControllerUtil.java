...
//				SessionFactory.setAttribute("userco", utilisateur);
	...
	@RequestMapping(value = "/user/disconnect", method = RequestMethod.POST)
	public String disconnect(@ModelAttribute("deco") Utilisateur utilisateur, BindingResult result) {
